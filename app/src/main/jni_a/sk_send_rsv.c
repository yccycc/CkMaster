...
void set_baudrate(int speed) {
    OXTABS
   // OPOST ,OLCUC,ONLCR,ONOCR,OCRNL,ONLRET,OXTABS,
   // B600,B1800,B57600,B76800,B115200
   // ISIG,ICANON,ECHO,ECHOE,ECHOK,ECHONL,ECHOPRT,TOSTOP


    O_APPEND,O_ASYNC,O_CLOEXEC,O_CREAT,O_DIRECT,O_DIRECTORY,O_EXCL,O_LARGEFILE,O_NOATIME,O_NOCTTY,O_NOFOLLOW,O_NONBLOCK,O_NDELAY,O_SYNC,O_TRUNC
